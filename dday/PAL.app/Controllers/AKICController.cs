...
{
    [Authorize]
    public class AKICController : Controller
    {
        private readonly IGenericRepository<AKICSlot> repo;
        private readonly IGenericRepository<CampusReservation> reserverepo;
        private readonly IMapper mapper;
        public AKICController(IGenericRepository<AKICSlot> repo, IMapper mapper, IGenericRepository<CampusReservation> reserverepo)
        {
            this.repo = repo;
            this.mapper = mapper;
        ...
        [HttpGet]
        public async Task<IActionResult> Reservation(int AKICSlotId, string AKICCampus)
        {
            var slot = await repo.GetAsync(AKICSlotId);
        ...
        public async Task<IActionResult> Edit(int SlotId)
        {
            ...
            {
                return RedirectToAction("AKICIndex", "Campus");
            }
        }
        ...
        public async Task<IActionResult> AKICReservationDetails()
        {
