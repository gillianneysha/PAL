...
namespace PAL.app.Controllers
{
    ...
    {
        private readonly IGenericRepository<PETERSlot> repo;
        private readonly IGenericRepository<CampusReservation> reserverepo;
        private readonly IMapper mapper;
        public PETERController(IGenericRepository<PETERSlot> repo, IMapper mapper, IGenericRepository<CampusReservation> reserverepo)
        {
            this.repo = repo;
            this.mapper = mapper;
        ...
        [HttpGet]
        public async Task<IActionResult> Reservation(int PETERSlotId, string PETERCampus)
        {
            var slot = await repo.GetAsync(PETERSlotId);
        ...
        public async Task<IActionResult> Edit(int SlotId)
        {
            ...
            {
                return RedirectToAction("PeterIndex", "Campus");
            }
        }
        ...
        public async Task<IActionResult> PETERReservationDetails()
        {
